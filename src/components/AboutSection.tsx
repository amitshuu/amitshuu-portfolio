        ...
        <div className="flex items-center justify-between ">
          ...
          <div className="flex flex-col items-center ">
            ...
            <p className="hidden mb-5 text-xl font-normal text-center text-gray-300 md:block md:text-2xl xl:w-3/4">
              ...
              MongoDB, and I'm always eager to learn more. When I'm not working
              on web development projects, I enjoy surfing and hitting the gym
              to stay active and healthy. I'm passionate about building
              user-friendly web applications and love collaborating with others
              to bring ideas to life. Whether I'm designing a sleek front-end
              interface or working on complex back-end functionality, I'm always
              striving to deliver high-quality results.
            </p>
            <p className="block text-lg font-normal leading-normal text-center text-gray-300 md:hidden xl:w-3/4">
              ...
              front-end and back-end development. I'm skilled in JavaScript,
              React, Node.js, and MongoDB, among other technologies. I enjoy
              building user-friendly web applications and collaborating with
              others to bring ideas to life. When I'm not coding, I like to surf
              and hit the gym.
            </p>
          </div>
        </div>
