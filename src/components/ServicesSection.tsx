  ...
  return (
    <>
      <section className='flex-col items-center justify-center w-full py-20 md:py-32 w-flex section-center bg-dark-bg'>
        ...
        <div className='flex flex-wrap justify-center max-w-full gap-8 xl:justify-between xl:gap-10 xl:flex-nowrap'>
          {services_links.map((service) => {
            return (
              <article className='container flex flex-col items-center max-w-md px-4 py-8 transition-transform cursor-pointer hover:transform hover:scale-105 rounded-2xl bg-primary-section'>
                <img
